...
namespace JitterDemo
{
    ...
    public class QuadDrawer : DrawableGameComponent
    {
        ...
        {
            texture = this.Game.Content.Load<Texture2D>("Texture/checker");
        ...
        public void Draw(GameTime gameTime, Matrix view, Matrix projection) //, Matrix view, Matrix projection
        {
