...
{
    public enum BodyTag { DrawMe, DontDrawMe,CompoundOBJ }
    ...
    public class JitterDemo : Microsoft.Xna.Framework.Game
    {
        ...
        Stopwatch riftWatch = new Stopwatch();
        ...
        void DrawEyeViewIntoBackbuffer(int eye)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(renderTargetEye[0], new Rectangle(offset, 0, width, height), Color.White);
            spriteBatch.End();
        }
