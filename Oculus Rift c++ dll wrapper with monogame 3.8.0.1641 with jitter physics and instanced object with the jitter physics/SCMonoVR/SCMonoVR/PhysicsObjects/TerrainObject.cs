...
namespace JitterDemo
{
    public class TerrainObject : DrawableGameComponent
    {
        ...
        public void Draw(GameTime gameTime, Matrix view, Matrix projection) //override  //, Matrix view, Matrix projection
        {
            //Console.WriteLine("TerrainObject");
            effect.DiffuseColor = Color.Red.ToVector3();
            primitive.AddWorldMatrix(worldMatrix);
            primitive.Draw(effect, view, projection);
        }
    }
}
