...
namespace JitterDemo
{
    public class ConvexHullObject : DrawableGameComponent
    {
        ...
        {
            //Console.WriteLine("spawn convex");
            model = Game.Content.Load<Model>("Model/convexhull");
        ...
        public void Draw(GameTime gameTime, Matrix view,Matrix projection) //override //GameTime gameTime, Matrix view,Matrix projection
        {
            //Console.WriteLine("convexHUll");
            ...
            foreach (ModelMesh mesh in model.Meshes)
            {
                ...
                {
                    effect.View = view;//((JitterDemo)Game).Camera.View;
                    effect.EnableDefaultLighting();
                    effect.Projection = projection;//((JitterDemo)Game).Camera.Projection;
